...
from models_settransformer.models import SetTransformer
from utils import AverageValueMeter, set_random_seed, save, resume
from datasets import get_datasets
from engine import train_one_epoch_supervised, validate_supervised
...
def main_worker(save_dir, args, cur_time):
    ...
    model = SetTransformer(dim_input=args.input_dim, dim_hidden=args.hidden_dim, n_classes=num_groups, num_seeds=args.num_seeds, num_heads=args.num_heads, ln=args.ln)
